...
exports.closeComPort = exports.openComPort = exports.writeRoobuckTag = exports.readTag = exports.scanTag = exports.writeTag = exports.sleep = exports.parser = void 0;
...
function writeTag(comPort, input, dataParser) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        */
        ...
        // console.log(comms);
        yield command(comPort, "041007\r", dataParser); // Initialise LEDs
        yield command(comPort, "041101\r", dataParser); // Turn Red LED On
                ...
                if (scanResult) {
                    ...
                    comms.forEach((comm) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (!writeResult || !Buffer.isBuffer(writeResult) || writeResult.subarray(0, 4).toString() !== "0001") {
                            ...
                            yield command(comPort, "041201\r", dataParser); // Turn Red LED Off
                            process.exit(1);
                        }
                    }));
                    break;
        ...
        */
        ...
        while (runLoop) {
            ...
            try {
                ...
                if (scanResult) {
                    // console.log(scanResult);
                    yield command(comPort, "041107\r", dataParser); // Turn all LEDs on
                    comms.forEach((comm) => __awaiter(this, void 0, void 0, function* () {
                        const writeResult = yield command(comPort, comm + "\r", dataParser);
                        // console.log(writeResult);
                        if (!writeResult || !Buffer.isBuffer(writeResult) || writeResult.subarray(0, 4).toString() !== "0001") {
 ...
 */
function openComPort(port, parser = true) {
    return __awaiter(this, void 0, void 0, function* () {
        if (port) {
            ...
            const comPort = new serialport_1.SerialPort({ path: nfcPortInfo[0].path, baudRate: 9600 }, (err) => {
                if (err) {
                    console.error(err.message);
                    // console.log("Unable to open serial port, exiting");
                    process.exit(1);
...
function readTag(comPort, dataParser, beep = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield command(comPort, "041007\r", dataParser); // Initialise all LEDs
        yield command(comPort, "041101\r", dataParser); // Turn Red LED On
        // eslint-disable-next-line no-constant-condition
        while (true) {
            try {
...
function closeComPort(comPort, dataParser) {
    return __awaiter(this, void 0, void 0, function* () {
        yield command(comPort, "041207\r", dataParser);
        comPort.close();
    });
}
exports.closeComPort = closeComPort;
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [comPort, dataParser] = nfcPort ? yield openComPort(nfcPort) : yield openComPort();
        if (!dataParser) {
            return;
        }
        yield command(comPort, "041007\r", dataParser); // Initialise all LEDs
        yield command(comPort, "041102\r", dataParser); // Turn Green LED On
        if (args["r"]) {
            // console.log("Reading Tags");
            console.log(yield readTag(comPort, dataParser));
        }
