  ...
  */
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'Department' ? DepartmentGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Area' ? AreaGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Department' ? DepartmentGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof User ? User[P] : never
  } 
    : User
  : User
