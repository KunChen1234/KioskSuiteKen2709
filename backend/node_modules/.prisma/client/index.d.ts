...
/**
   ...
   * `prisma.loginInfo`: Exposes CRUD operations for the **LoginInfo** model.
    ...
    * ```
    */
  get loginInfo(): Prisma.LoginInfoDelegate<GlobalReject>;
  ...
  */
  ...
  export type AreaGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends '_count' ? AreaCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Users' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? AreaCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Area ? Area[P] : never
  } 
    : Area
  : Area
  ...
  export interface AreaDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Area'> extends True ? CheckSelect<T, Prisma__AreaClient<Area>, Prisma__AreaClient<AreaGetPayload<T>>> : CheckSelect<T, Prisma__AreaClient<Area | null, null>, Prisma__AreaClient<AreaGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Area'> extends True ? CheckSelect<T, Prisma__AreaClient<Area>, Prisma__AreaClient<AreaGetPayload<T>>> : CheckSelect<T, Prisma__AreaClient<Area | null, null>, Prisma__AreaClient<AreaGetPayload<T> | null, null>>
   ...
   */
  export class Prisma__AreaClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  export type UserSelect = {
    ...
    LoginInfo?: boolean | LoginInfoFindManyArgs
  ...
  export type UserGetPayload<
    ...
    ? User  & {
    [P in TrueKeys<S['include']>]:
        P extends 'Area' ? AreaGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Department' ? DepartmentGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'LoginInfo' ? Array < LoginInfoGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Area' ? AreaGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Department' ? DepartmentGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'LoginInfo' ? Array < LoginInfoGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    LoginInfo<T extends LoginInfoFindManyArgs = {}>(args?: Subset<T, LoginInfoFindManyArgs>): CheckSelect<T, PrismaPromise<Array<LoginInfo>| Null>, PrismaPromise<Array<LoginInfoGetPayload<T>>| Null>>;
  ...
  export type DepartmentGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'Users' ? Array < UserGetPayload<Exclude<S['include'], undefined | null>[P]>>  :
        P extends '_count' ? DepartmentCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'Users' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? DepartmentCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Department ? Department[P] : never
  } 
    : Department
  : Department
  ...
  export interface DepartmentDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Department'> extends True ? CheckSelect<T, Prisma__DepartmentClient<Department>, Prisma__DepartmentClient<DepartmentGetPayload<T>>> : CheckSelect<T, Prisma__DepartmentClient<Department | null, null>, Prisma__DepartmentClient<DepartmentGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Department'> extends True ? CheckSelect<T, Prisma__DepartmentClient<Department>, Prisma__DepartmentClient<DepartmentGetPayload<T>>> : CheckSelect<T, Prisma__DepartmentClient<Department | null, null>, Prisma__DepartmentClient<DepartmentGetPayload<T> | null, null>>
  ...
  export type LoginInfoAggregateArgs = {
    /**
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<LoginInfoOrderByWithRelationInput>
    /**
     * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
     * 
     * Sets the start position
  ...
  export type LoginInfoGroupByArgs = {
    where?: LoginInfoWhereInput
    orderBy?: Enumerable<LoginInfoOrderByWithAggregationInput>
    by: Array<LoginInfoScalarFieldEnum>
  ...
  type GetLoginInfoGroupByPayload<T extends LoginInfoGroupByArgs> = PrismaPromise<
    Array<
      PickArray<LoginInfoGroupByOutputType, T['by']> &
        {
  ...
  export type LoginInfoInclude = {
    User?: boolean | UserArgs
    Location?: boolean | LocationArgs
  }

  export type LoginInfoGetPayload<
    S extends boolean | null | undefined | LoginInfoArgs,
    U = keyof S
      > = S extends true
        ? LoginInfo
    : S extends undefined
    ? never
    : S extends LoginInfoArgs | LoginInfoFindManyArgs
    ?'include' extends U
    ? LoginInfo  & {
    [P in TrueKeys<S['include']>]:
        P extends 'User' ? UserGetPayload<Exclude<S['include'], undefined | null>[P]> | null :
        P extends 'Location' ? LocationGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'User' ? UserGetPayload<Exclude<S['select'], undefined | null>[P]> | null :
        P extends 'Location' ? LocationGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof LoginInfo ? LoginInfo[P] : never
  } 
    : LoginInfo
  : LoginInfo


  type LoginInfoCountArgs = Merge<
    Omit<LoginInfoFindManyArgs, 'select' | 'include'> & {
      select?: LoginInfoCountAggregateInputType | true
    }
  >

  export interface LoginInfoDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
     ...
     * })
    **/
    findUnique<T extends LoginInfoFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, LoginInfoFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'LoginInfo'> extends True ? CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>> : CheckSelect<T, Prisma__LoginInfoClient<LoginInfo | null, null>, Prisma__LoginInfoClient<LoginInfoGetPayload<T> | null, null>>
     ...
     * })
    **/
    findFirst<T extends LoginInfoFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, LoginInfoFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'LoginInfo'> extends True ? CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>> : CheckSelect<T, Prisma__LoginInfoClient<LoginInfo | null, null>, Prisma__LoginInfoClient<LoginInfoGetPayload<T> | null, null>>
     ...
     * 
    **/
    findMany<T extends LoginInfoFindManyArgs>(
      args?: SelectSubset<T, LoginInfoFindManyArgs>
    ): CheckSelect<T, PrismaPromise<Array<LoginInfo>>, PrismaPromise<Array<LoginInfoGetPayload<T>>>>
     ...
     * 
    **/
    create<T extends LoginInfoCreateArgs>(
      args: SelectSubset<T, LoginInfoCreateArgs>
    ): CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>>
     ...
     *     
    **/
    createMany<T extends LoginInfoCreateManyArgs>(
      args?: SelectSubset<T, LoginInfoCreateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends LoginInfoDeleteArgs>(
      args: SelectSubset<T, LoginInfoDeleteArgs>
    ): CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>>
     ...
     * 
    **/
    update<T extends LoginInfoUpdateArgs>(
      args: SelectSubset<T, LoginInfoUpdateArgs>
    ): CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>>
     ...
     * 
    **/
    deleteMany<T extends LoginInfoDeleteManyArgs>(
      args?: SelectSubset<T, LoginInfoDeleteManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends LoginInfoUpdateManyArgs>(
      args: SelectSubset<T, LoginInfoUpdateManyArgs>
    ): PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends LoginInfoUpsertArgs>(
      args: SelectSubset<T, LoginInfoUpsertArgs>
    ): CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>>

    /**
     * Find one LoginInfo that matches the filter or throw
     * `NotFoundError` if no matches were found.
     ...
     * })
    **/
    findUniqueOrThrow<T extends LoginInfoFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, LoginInfoFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends LoginInfoFindFirstOrThrowArgs>(
      args?: SelectSubset<T, LoginInfoFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__LoginInfoClient<LoginInfo>, Prisma__LoginInfoClient<LoginInfoGetPayload<T>>>
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends LoginInfoAggregateArgs>(args: Subset<T, LoginInfoAggregateArgs>): PrismaPromise<GetLoginInfoAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, LoginInfoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLoginInfoGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__LoginInfoClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
  ...
  /**
   * LoginInfo base type for findUnique actions
   */
  export type LoginInfoFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
    select?: LoginInfoSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     * 
    **/
    include?: LoginInfoInclude | null
    /**
   ...
   */
  export interface LoginInfoFindUniqueArgs extends LoginInfoFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * LoginInfo base type for findFirst actions
   */
  export type LoginInfoFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
    ...
    **/
     ...
     * 
    **/
    distinct?: Enumerable<LoginInfoScalarFieldEnum>
  }

  /**
   * LoginInfo: findFirst
   */
  export interface LoginInfoFindFirstArgs extends LoginInfoFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   * LoginInfo findMany
   */
  export type LoginInfoFindManyArgs = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
   ...
   * LoginInfo create
   */
  export type LoginInfoCreateArgs = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
   ...
   */
  export type LoginInfoCreateManyArgs = {
    /**
     * The data used to create many LoginInfos.
     * 
    **/
    data: Enumerable<LoginInfoCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * LoginInfo update
   */
  export type LoginInfoUpdateArgs = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
   ...
   */
  export type LoginInfoUpdateManyArgs = {
    /**
   ...
   * LoginInfo upsert
   */
  export type LoginInfoUpsertArgs = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
   ...
   * LoginInfo delete
   */
  export type LoginInfoDeleteArgs = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
   ...
   */
  export type LoginInfoDeleteManyArgs = {
    /**
   ...
   */
  export type LoginInfoFindUniqueOrThrowArgs = LoginInfoFindUniqueArgsBase
      

  /**
   * LoginInfo: findFirstOrThrow
   */
  export type LoginInfoFindFirstOrThrowArgs = LoginInfoFindFirstArgsBase
      

  /**
   * LoginInfo without action
   */
  export type LoginInfoArgs = {
    /**
     * Select specific fields to fetch from the LoginInfo
     * 
    **/
  ...
  export type AreaWhereInput = {
    ...
    id?: IntFilter | number
    areaName?: StringNullableFilter | string | null
    areaColor?: StringNullableFilter | string | null
  ...
  export type AreaScalarWhereWithAggregatesInput = {
    ...
    areaName?: StringNullableWithAggregatesFilter | string | null
    areaColor?: StringNullableWithAggregatesFilter | string | null
  }
  ...
  export type UserOrderByWithRelationInput = {
    ...
    LoginInfo?: LoginInfoOrderByRelationAggregateInput
  }
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    areaName?: StringNullableWithAggregatesFilter | string | null
    departmentName?: StringNullableWithAggregatesFilter | string | null
  }
  ...
  export type DepartmentWhereInput = {
    ...
    id?: IntFilter | number
    departmentName?: StringNullableFilter | string | null
    departmentColor?: StringNullableFilter | string | null
    Users?: UserListRelationFilter
  }
  ...
  export type DepartmentScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    departmentName?: StringNullableWithAggregatesFilter | string | null
    departmentColor?: StringNullableWithAggregatesFilter | string | null
  }

  export type LoginInfoWhereInput = {
    AND?: Enumerable<LoginInfoWhereInput>
    OR?: Enumerable<LoginInfoWhereInput>
    NOT?: Enumerable<LoginInfoWhereInput>
    id?: IntFilter | number
    User?: XOR<UserRelationFilter, UserWhereInput> | null
    userID?: StringFilter | string
    LoginTime?: StringFilter | string
    LampMAC?: StringFilter | string
    LampSN?: StringFilter | string
    Location?: XOR<LocationRelationFilter, LocationWhereInput> | null
    LampBssid?: StringNullableFilter | string | null
    LastUpdateTime?: StringNullableFilter | string | null
    isDayShift?: BoolFilter | boolean
  }
  ...
  export type LoginInfoOrderByWithRelationInput = {
    ...
    isDayShift?: SortOrder
  }

  export type LoginInfoWhereUniqueInput = {
    id?: number
  }
  ...
  export type LoginInfoScalarWhereWithAggregatesInput = {
    AND?: Enumerable<LoginInfoScalarWhereWithAggregatesInput>
    OR?: Enumerable<LoginInfoScalarWhereWithAggregatesInput>
    NOT?: Enumerable<LoginInfoScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    userID?: StringWithAggregatesFilter | string
    LoginTime?: StringWithAggregatesFilter | string
    LampMAC?: StringWithAggregatesFilter | string
    LampSN?: StringWithAggregatesFilter | string
    LampBssid?: StringNullableWithAggregatesFilter | string | null
    LastUpdateTime?: StringNullableWithAggregatesFilter | string | null
    isDayShift?: BoolWithAggregatesFilter | boolean
  }
  ...
  export type LocationWhereInput = {
    ...
    BSSID?: StringNullableFilter | string | null
    LoginInfo?: LoginInfoListRelationFilter
  }
  ...
  export type LocationScalarWhereWithAggregatesInput = {
    ...
    BSSID?: StringNullableWithAggregatesFilter | string | null
  }
  ...
  export type AreaUpdateInput = {
    ...
    areaColor?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type UserCreateInput = {
    ...
    LoginInfo?: LoginInfoCreateNestedManyWithoutUserInput
  }
  ...
  export type UserUncheckedCreateInput = {
    ...
    areaName?: string | null
    departmentName?: string | null
    LoginInfo?: LoginInfoUncheckedCreateNestedManyWithoutUserInput
  }
  ...
  export type UserUpdateInput = {
    ...
    LoginInfo?: LoginInfoUpdateManyWithoutUserNestedInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    LoginInfo?: LoginInfoUncheckedUpdateManyWithoutUserNestedInput
  }
  ...
  export type DepartmentUpdateInput = {
    departmentName?: NullableStringFieldUpdateOperationsInput | string | null
    departmentColor?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type LoginInfoCreateInput = {
    User?: UserCreateNestedOneWithoutLoginInfoInput
    LoginTime: string
    LampMAC: string
    LampSN: string
    Location?: LocationCreateNestedOneWithoutLoginInfoInput
    LastUpdateTime?: string | null
    isDayShift: boolean
  }
  ...
  export type LoginInfoUpdateInput = {
    User?: UserUpdateOneWithoutLoginInfoNestedInput
    LoginTime?: StringFieldUpdateOperationsInput | string
    LampMAC?: StringFieldUpdateOperationsInput | string
    LampSN?: StringFieldUpdateOperationsInput | string
    Location?: LocationUpdateOneWithoutLoginInfoNestedInput
    LastUpdateTime?: NullableStringFieldUpdateOperationsInput | string | null
    isDayShift?: BoolFieldUpdateOperationsInput | boolean
  }
  ...
  export type LoginInfoUncheckedUpdateInput = {
    ...
    LampMAC?: StringFieldUpdateOperationsInput | string
    LampSN?: StringFieldUpdateOperationsInput | string
    LampBssid?: NullableStringFieldUpdateOperationsInput | string | null
    LastUpdateTime?: NullableStringFieldUpdateOperationsInput | string | null
    isDayShift?: BoolFieldUpdateOperationsInput | boolean
  }
  ...
  export type LocationCreateInput = {
    locationName?: string | null
    BSSID?: string | null
    LoginInfo?: LoginInfoCreateNestedManyWithoutLocationInput
  }
  ...
  export type LocationUncheckedCreateInput = {
    ...
    locationName?: string | null
    BSSID?: string | null
    LoginInfo?: LoginInfoUncheckedCreateNestedManyWithoutLocationInput
  }
  ...
  export type LocationUpdateInput = {
    ...
    LoginInfo?: LoginInfoUpdateManyWithoutLocationNestedInput
  }
  ...
  export type LocationUncheckedUpdateInput = {
    ...
    locationName?: NullableStringFieldUpdateOperationsInput | string | null
    BSSID?: NullableStringFieldUpdateOperationsInput | string | null
    LoginInfo?: LoginInfoUncheckedUpdateManyWithoutLocationNestedInput
  }
  ...
  export type LoginInfoListRelationFilter = {
    every?: LoginInfoWhereInput
    some?: LoginInfoWhereInput
    none?: LoginInfoWhereInput
  }

  export type LoginInfoOrderByRelationAggregateInput = {
    _count?: SortOrder
  }
  ...
  export type UserCreateNestedManyWithoutAreaInput = {
    create?: XOR<Enumerable<UserCreateWithoutAreaInput>, Enumerable<UserUncheckedCreateWithoutAreaInput>>
    connectOrCreate?: Enumerable<UserCreateOrConnectWithoutAreaInput>
  ...
  export type UserUpdateManyWithoutAreaNestedInput = {
    create?: XOR<Enumerable<UserCreateWithoutAreaInput>, Enumerable<UserUncheckedCreateWithoutAreaInput>>
    connectOrCreate?: Enumerable<UserCreateOrConnectWithoutAreaInput>
    upsert?: Enumerable<UserUpsertWithWhereUniqueWithoutAreaInput>
    createMany?: UserCreateManyAreaInputEnvelope
    set?: Enumerable<UserWhereUniqueInput>
    disconnect?: Enumerable<UserWhereUniqueInput>
    delete?: Enumerable<UserWhereUniqueInput>
    connect?: Enumerable<UserWhereUniqueInput>
    update?: Enumerable<UserUpdateWithWhereUniqueWithoutAreaInput>
    updateMany?: Enumerable<UserUpdateManyWithWhereWithoutAreaInput>
  ...
  export type LoginInfoCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutUserInput>, Enumerable<LoginInfoUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutUserInput>
    createMany?: LoginInfoCreateManyUserInputEnvelope
    connect?: Enumerable<LoginInfoWhereUniqueInput>
  }

  export type LoginInfoUncheckedCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutUserInput>, Enumerable<LoginInfoUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutUserInput>
    createMany?: LoginInfoCreateManyUserInputEnvelope
    connect?: Enumerable<LoginInfoWhereUniqueInput>
  ...
  export type LoginInfoUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutUserInput>, Enumerable<LoginInfoUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<LoginInfoUpsertWithWhereUniqueWithoutUserInput>
    createMany?: LoginInfoCreateManyUserInputEnvelope
    set?: Enumerable<LoginInfoWhereUniqueInput>
    disconnect?: Enumerable<LoginInfoWhereUniqueInput>
    delete?: Enumerable<LoginInfoWhereUniqueInput>
    connect?: Enumerable<LoginInfoWhereUniqueInput>
    update?: Enumerable<LoginInfoUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<LoginInfoUpdateManyWithWhereWithoutUserInput>
    deleteMany?: Enumerable<LoginInfoScalarWhereInput>
  }

  export type LoginInfoUncheckedUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutUserInput>, Enumerable<LoginInfoUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<LoginInfoUpsertWithWhereUniqueWithoutUserInput>
    createMany?: LoginInfoCreateManyUserInputEnvelope
  ...
  export type UserCreateNestedOneWithoutLoginInfoInput = {
    create?: XOR<UserCreateWithoutLoginInfoInput, UserUncheckedCreateWithoutLoginInfoInput>
    connectOrCreate?: UserCreateOrConnectWithoutLoginInfoInput
    connect?: UserWhereUniqueInput
  }

  export type LocationCreateNestedOneWithoutLoginInfoInput = {
    create?: XOR<LocationCreateWithoutLoginInfoInput, LocationUncheckedCreateWithoutLoginInfoInput>
    connectOrCreate?: LocationCreateOrConnectWithoutLoginInfoInput
    connect?: LocationWhereUniqueInput
  }

  export type UserUpdateOneWithoutLoginInfoNestedInput = {
    create?: XOR<UserCreateWithoutLoginInfoInput, UserUncheckedCreateWithoutLoginInfoInput>
    connectOrCreate?: UserCreateOrConnectWithoutLoginInfoInput
    upsert?: UserUpsertWithoutLoginInfoInput
    disconnect?: boolean
    delete?: boolean
    connect?: UserWhereUniqueInput
    update?: XOR<UserUpdateWithoutLoginInfoInput, UserUncheckedUpdateWithoutLoginInfoInput>
  }

  export type LocationUpdateOneWithoutLoginInfoNestedInput = {
    create?: XOR<LocationCreateWithoutLoginInfoInput, LocationUncheckedCreateWithoutLoginInfoInput>
    connectOrCreate?: LocationCreateOrConnectWithoutLoginInfoInput
    upsert?: LocationUpsertWithoutLoginInfoInput
    disconnect?: boolean
    delete?: boolean
    connect?: LocationWhereUniqueInput
    update?: XOR<LocationUpdateWithoutLoginInfoInput, LocationUncheckedUpdateWithoutLoginInfoInput>
  }
  ...
  export type LoginInfoCreateNestedManyWithoutLocationInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutLocationInput>, Enumerable<LoginInfoUncheckedCreateWithoutLocationInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutLocationInput>
    createMany?: LoginInfoCreateManyLocationInputEnvelope
    connect?: Enumerable<LoginInfoWhereUniqueInput>
  }

  export type LoginInfoUncheckedCreateNestedManyWithoutLocationInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutLocationInput>, Enumerable<LoginInfoUncheckedCreateWithoutLocationInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutLocationInput>
    createMany?: LoginInfoCreateManyLocationInputEnvelope
    connect?: Enumerable<LoginInfoWhereUniqueInput>
  ...
  export type LoginInfoUpdateManyWithoutLocationNestedInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutLocationInput>, Enumerable<LoginInfoUncheckedCreateWithoutLocationInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutLocationInput>
    upsert?: Enumerable<LoginInfoUpsertWithWhereUniqueWithoutLocationInput>
    createMany?: LoginInfoCreateManyLocationInputEnvelope
    set?: Enumerable<LoginInfoWhereUniqueInput>
    disconnect?: Enumerable<LoginInfoWhereUniqueInput>
    delete?: Enumerable<LoginInfoWhereUniqueInput>
    connect?: Enumerable<LoginInfoWhereUniqueInput>
    update?: Enumerable<LoginInfoUpdateWithWhereUniqueWithoutLocationInput>
    updateMany?: Enumerable<LoginInfoUpdateManyWithWhereWithoutLocationInput>
    deleteMany?: Enumerable<LoginInfoScalarWhereInput>
  }

  export type LoginInfoUncheckedUpdateManyWithoutLocationNestedInput = {
    create?: XOR<Enumerable<LoginInfoCreateWithoutLocationInput>, Enumerable<LoginInfoUncheckedCreateWithoutLocationInput>>
    connectOrCreate?: Enumerable<LoginInfoCreateOrConnectWithoutLocationInput>
    upsert?: Enumerable<LoginInfoUpsertWithWhereUniqueWithoutLocationInput>
    createMany?: LoginInfoCreateManyLocationInputEnvelope
  ...
  export type UserCreateManyAreaInputEnvelope = {
    data: Enumerable<UserCreateManyAreaInput>
    skipDuplicates?: boolean
  }
  ...
  export type LoginInfoCreateOrConnectWithoutUserInput = {
    where: LoginInfoWhereUniqueInput
    create: XOR<LoginInfoCreateWithoutUserInput, LoginInfoUncheckedCreateWithoutUserInput>
  }

  export type LoginInfoCreateManyUserInputEnvelope = {
    data: Enumerable<LoginInfoCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type LoginInfoUpsertWithWhereUniqueWithoutUserInput = {
    where: LoginInfoWhereUniqueInput
    update: XOR<LoginInfoUpdateWithoutUserInput, LoginInfoUncheckedUpdateWithoutUserInput>
    create: XOR<LoginInfoCreateWithoutUserInput, LoginInfoUncheckedCreateWithoutUserInput>
  }

  export type LoginInfoUpdateWithWhereUniqueWithoutUserInput = {
    where: LoginInfoWhereUniqueInput
    data: XOR<LoginInfoUpdateWithoutUserInput, LoginInfoUncheckedUpdateWithoutUserInput>
  }

  export type LoginInfoUpdateManyWithWhereWithoutUserInput = {
    where: LoginInfoScalarWhereInput
    data: XOR<LoginInfoUpdateManyMutationInput, LoginInfoUncheckedUpdateManyWithoutLoginInfoInput>
  }

  export type LoginInfoScalarWhereInput = {
    AND?: Enumerable<LoginInfoScalarWhereInput>
    OR?: Enumerable<LoginInfoScalarWhereInput>
    NOT?: Enumerable<LoginInfoScalarWhereInput>
    id?: IntFilter | number
    userID?: StringFilter | string
    LoginTime?: StringFilter | string
    LampMAC?: StringFilter | string
  ...
  export type UserCreateWithoutLoginInfoInput = {
    userID?: string | null
    firstName?: string | null
    lastName?: string | null
    photo?: string
  ...
  export type UserUncheckedCreateWithoutLoginInfoInput = {
    id?: number
    userID?: string | null
    firstName?: string | null
    lastName?: string | null
  ...
  export type UserCreateOrConnectWithoutLoginInfoInput = {
    where: UserWhereUniqueInput
    create: XOR<UserCreateWithoutLoginInfoInput, UserUncheckedCreateWithoutLoginInfoInput>
  }

  export type LocationCreateWithoutLoginInfoInput = {
    locationName?: string | null
    BSSID?: string | null
  }

  export type LocationUncheckedCreateWithoutLoginInfoInput = {
    id?: number
    locationName?: string | null
    BSSID?: string | null
  }

  export type LocationCreateOrConnectWithoutLoginInfoInput = {
    where: LocationWhereUniqueInput
    create: XOR<LocationCreateWithoutLoginInfoInput, LocationUncheckedCreateWithoutLoginInfoInput>
  }

  export type UserUpsertWithoutLoginInfoInput = {
    update: XOR<UserUpdateWithoutLoginInfoInput, UserUncheckedUpdateWithoutLoginInfoInput>
    create: XOR<UserCreateWithoutLoginInfoInput, UserUncheckedCreateWithoutLoginInfoInput>
  }

  export type UserUpdateWithoutLoginInfoInput = {
    userID?: NullableStringFieldUpdateOperationsInput | string | null
    firstName?: NullableStringFieldUpdateOperationsInput | string | null
    lastName?: NullableStringFieldUpdateOperationsInput | string | null
    photo?: StringFieldUpdateOperationsInput | string
  ...
  export type UserUncheckedUpdateWithoutLoginInfoInput = {
    id?: IntFieldUpdateOperationsInput | number
    userID?: NullableStringFieldUpdateOperationsInput | string | null
    firstName?: NullableStringFieldUpdateOperationsInput | string | null
    lastName?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type LocationUpsertWithoutLoginInfoInput = {
    update: XOR<LocationUpdateWithoutLoginInfoInput, LocationUncheckedUpdateWithoutLoginInfoInput>
    create: XOR<LocationCreateWithoutLoginInfoInput, LocationUncheckedCreateWithoutLoginInfoInput>
  }

  export type LocationUpdateWithoutLoginInfoInput = {
    locationName?: NullableStringFieldUpdateOperationsInput | string | null
    BSSID?: NullableStringFieldUpdateOperationsInput | string | null
  }

  export type LocationUncheckedUpdateWithoutLoginInfoInput = {
    id?: IntFieldUpdateOperationsInput | number
    locationName?: NullableStringFieldUpdateOperationsInput | string | null
    BSSID?: NullableStringFieldUpdateOperationsInput | string | null
  }

  export type LoginInfoCreateWithoutLocationInput = {
    User?: UserCreateNestedOneWithoutLoginInfoInput
    LoginTime: string
    LampMAC: string
    LampSN: string
  ...
  export type LoginInfoUncheckedCreateWithoutLocationInput = {
    id?: number
    userID: string
    LoginTime: string
    LampMAC: string
  ...
  export type LoginInfoCreateOrConnectWithoutLocationInput = {
    where: LoginInfoWhereUniqueInput
    create: XOR<LoginInfoCreateWithoutLocationInput, LoginInfoUncheckedCreateWithoutLocationInput>
  }

  export type LoginInfoCreateManyLocationInputEnvelope = {
    data: Enumerable<LoginInfoCreateManyLocationInput>
    skipDuplicates?: boolean
  }

  export type LoginInfoUpsertWithWhereUniqueWithoutLocationInput = {
    where: LoginInfoWhereUniqueInput
    update: XOR<LoginInfoUpdateWithoutLocationInput, LoginInfoUncheckedUpdateWithoutLocationInput>
    create: XOR<LoginInfoCreateWithoutLocationInput, LoginInfoUncheckedCreateWithoutLocationInput>
  }

  export type LoginInfoUpdateWithWhereUniqueWithoutLocationInput = {
    where: LoginInfoWhereUniqueInput
    data: XOR<LoginInfoUpdateWithoutLocationInput, LoginInfoUncheckedUpdateWithoutLocationInput>
  }

  export type LoginInfoUpdateManyWithWhereWithoutLocationInput = {
    where: LoginInfoScalarWhereInput
    data: XOR<LoginInfoUpdateManyMutationInput, LoginInfoUncheckedUpdateManyWithoutLoginInfoInput>
  }
  ...
  export type LoginInfoCreateManyUserInput = {
    id?: number
    LoginTime: string
    LampMAC: string
    LampSN: string
  ...
  export type LoginInfoUncheckedUpdateManyWithoutLoginInfoInput = {
    id?: IntFieldUpdateOperationsInput | number
    LoginTime?: StringFieldUpdateOperationsInput | string
    LampMAC?: StringFieldUpdateOperationsInput | string
    LampSN?: StringFieldUpdateOperationsInput | string
  ...
  export type LoginInfoCreateManyLocationInput = {
    id?: number
    userID: string
    LoginTime: string
    LampMAC: string
  ...
  export type LoginInfoUpdateWithoutLocationInput = {
    User?: UserUpdateOneWithoutLoginInfoNestedInput
    LoginTime?: StringFieldUpdateOperationsInput | string
    LampMAC?: StringFieldUpdateOperationsInput | string
    LampSN?: StringFieldUpdateOperationsInput | string
  ...
  export type LoginInfoUncheckedUpdateWithoutLocationInput = {
    id?: IntFieldUpdateOperationsInput | number
    userID?: StringFieldUpdateOperationsInput | string
    LoginTime?: StringFieldUpdateOperationsInput | string
    LampMAC?: StringFieldUpdateOperationsInput | string
